...
export function DefaultAvatarModel({
  ...
  return (
    <group>
      ...
      {/* 頭 (Head) - 胴体から少し浮いた位置 */}
      <mesh name="Head" castShadow position={[0, 0.65, 0]}>
      ...
      <group name="Eyes">
        {/* 白目 */}
        <mesh name="EyeWhite_R" castShadow position={[0.08, 0.7, 0.14]} scale={[1.25, 1.8, 1]}>
          <boxGeometry args={[0.04, 0.04, 0.04]} />
          <meshStandardMaterial color={COLORS.PENGUIN_WHITE} />
        </mesh>
        <mesh name="EyeWhite_L" castShadow position={[-0.08, 0.7, 0.14]} scale={[1.25, 1.8, 1]}>
          <boxGeometry args={[0.04, 0.04, 0.04]} />
          <meshStandardMaterial color={COLORS.PENGUIN_WHITE} />
        </mesh>
        {/* 黒目 */}
        <mesh name="Pupil_R" castShadow position={[0.08, 0.7, 0.16]} scale={[1.6, 1.6, 1]}>
          <boxGeometry args={[0.02, 0.02, 0.02]} />
          <meshStandardMaterial color={COLORS.PENGUIN_BLACK} />
        </mesh>
        <mesh name="Pupil_L" castShadow position={[-0.08, 0.7, 0.16]} scale={[1.6, 1.6, 1]}>
          <boxGeometry args={[0.02, 0.02, 0.02]} />
          <meshStandardMaterial color={COLORS.PENGUIN_BLACK} />
        </mesh>
      </group>
      ...
      {/* 腕 (Arms) */}
      <mesh name="Arm_R" castShadow position={[0.25, 0.4, 0.15]} rotation={[-1.6, 0, 0]}>
        <boxGeometry args={[0.1, 0.4, 0.1]} />
        <meshStandardMaterial color={color} />
      </mesh>
      <mesh name="Arm_L" castShadow position={[-0.25, 0.4, 0.15]} rotation={[-1.6, 0, 0]}>
        <boxGeometry args={[0.1, 0.4, 0.1]} />
        <meshStandardMaterial color={color} />
      </mesh>
